...
# CIRCUITPY-CHANGE: CircuitPython always enforces these bounds (OVERFLOW_CHECKS in py/binary.c).
is_v2 = hasattr(sys.implementation, "_v2") or sys.implementation.name == "circuitpython"
